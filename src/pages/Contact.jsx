...
const Contact = () => {
  return (
    <div className="px-4 md:px-8 lg:px-32">
      ...
      <div className="flex flex-col lg:flex-row justify-between mt-8 md:mt-12 text-center lg:mt-16 md:justify-center">
          ...
          >
            ...
            <div className="mb-4 text-center">
              <input
                type="submit"
                value="Send"
                className="px-4 py-2 bg-[#4E007A] text-white rounded-md cursor-pointer transition duration-300"
              />
            </div>
          </form>
        </div>
