  ...
  <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 px-2">
    <div className="bg-white p-4 rounded-lg hover:shadow-md">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-lg font-semibold text-[#4E007A]">JOB POSTING</h3>
          <p className="text-sm">Post job openings and find candidates within minutes</p>
        </div>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 px-2">
    <div className="bg-white p-4 rounded-lg hover:shadow-md">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-lg font-semibold text-[#4E007A]">JOB APPLICATION</h3>
          <p className="text-sm">Apply to multiple job applications that fit your skillset</p>
        </div>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 px-2">
    <div className="bg-white p-4 rounded-lg hover:shadow-md">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-lg font-semibold text-[#4E007A]">CV UPLOAD</h3>
          <p className="text-sm">Upload your resume to show your experiences and skillsets</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 px-2">
    <div className="bg-white p-4 rounded-lg hover:shadow-md">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-lg font-semibold text-[#4E007A]">PROFILES</h3>
          <p className="text-sm">Set your profile to market your career.</p>
        </div>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 px-2">
    <div className="bg-white p-4 rounded-lg hover:shadow-md">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-lg font-semibold text-[#4E007A]">FIND JOBS</h3>
          <p className="text-sm">Find endless opportunities just a click away.</p>
        </div>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 px-2">
    <div className="bg-white p-4 rounded-lg hover:shadow-md">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-lg font-semibold text-[#4E007A]">INDUSTRY SEARCH</h3>
          <p className="text-sm">Search industry wide for greater results .</p>
        </div>
      </div>
    </div>
  </div>
...
<div className="bg-gray-200 min-h-[30vh] flex flex-wrap items-center justify-center w-11/12 mx-auto md:p-8">
    ...
    <div className="flex w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-2">
      <div>
        <img src={countericon2} alt="/" className="bg-white rounded-full" />
      </div>
      <div className="ml-4">
    ...
    <div className="flex w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-2">
      <div>
        <img src={countericon1} alt="/" className="bg-white rounded-full" />
      </div>
      <div className="ml-4">
    ...
    <div className="flex w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-2">
      <div>
        <img src={countericon4} alt="/" className="bg-white rounded-full" />
      </div>
      <div className="ml-4">
