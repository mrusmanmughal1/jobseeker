        ...
        <div>
          <div className="flex   justify-between items-center">
            ...
            <div className="flex   items-center gap-6">
              <div className="flex gap-2 bg-btn-primary text-white   p-2 md:p-4 rounded-md ">
              ...
              <div className="flex gap-2 relative">
                ...
                <button className="md:text-2xl hover:border-red-700 border   transition-all duration-500  hover:border hover:shadow-lg shadow-md p-2 rounded-md hover:text-red-500 cursor-pointer">
                  {" "}
                  <IoMdLogOut />
                </button>
              </div>
